#!/usr/bin/env bash
# Fine-tune Qwen-2.5-VL-7B on a 70/30 Robomimic + Robo-Reward mix (2k steps)
...
DATASETS="robomimic%70,robo_reward_bench%30"   # 70/30 mix
...
# Output / tracking
############################
RUN_NAME="qwen2vl-7b-robomimic-mix-ft"
OUTPUT_DIR="./output_7b_robomimic_mix"
