#!/usr/bin/env bash
# Fine-tune Qwen3-VL-4B-Instruct on RoboReward (subset: roboreward_no_cut) on a single GPU
...
# Output / tracking
############################
RUN_NAME="qwen3vl-4b-roboreward_no_cut"
OUTPUT_DIR="./output_qwen3vl_4b_roboreward_no_cut_12_20_2025"
