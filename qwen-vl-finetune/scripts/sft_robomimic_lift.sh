#!/usr/bin/env bash
# Fine-tune Qwen-2.5-VL-3B on RoboMimic (lift task only)
...
# Output / tracking
############################
RUN_NAME="qwen2vl-3b-robomimic-ft-lift-only"
OUTPUT_DIR="./output_robomimic_3b_lift_only_8_16"
