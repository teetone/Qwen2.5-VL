#!/usr/bin/env bash
# Fine-tune Qwen-2.5-VL-3B on Robo-Reward bench (400 examples) – SHORTER RUN (1.5k steps)
...
MAX_STEPS=1500          # reduced from 3000
EVAL_STEPS=10
...
OUTPUT_DIR="./output_robomimic_8_5_short"
