#!/usr/bin/env bash
# Fine-tune Qwen-2.5-VL-3B on RoboMimic (square task only)
...
# Output / tracking
############################
RUN_NAME="qwen2vl-3b-robomimic-ft-square-only"
OUTPUT_DIR="./output_robomimic_3b_square_only_9_7"
