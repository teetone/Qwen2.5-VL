#!/usr/bin/env bash
# Fine-tune Qwen-2.5-VL-3B on RoboMimic (transport task only)
...
DATASETS="robomimic_transport%100"
...
# Output / tracking
############################
RUN_NAME="qwen2vl-3b-robomimic-ft-transport-only"
OUTPUT_DIR="./output_robomimic_3b_transport_only_8_7"
